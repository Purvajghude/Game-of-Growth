      ...
      <div className="relative mx-auto max-w-[1380px] px-6 lg:px-10">
        <div className="grid md:grid-cols-12 gap-10">
          <div className="md:col-span-6">
            <Link to="/" className="cursor-target inline-flex items-center gap-2.5" data-cursor="hover">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="mt-4 space-y-2 text-[15px] text-[var(--ink-2)]">
              <li><Link to="/work" className="cursor-target hover:text-[var(--ink)] transition" data-cursor="hover">Work</Link></li>
              <li><Link to="/studio" className="cursor-target hover:text-[var(--ink)] transition" data-cursor="hover">Studio</Link></li>
              <li><Link to="/store" className="cursor-target hover:text-[var(--ink)] transition" data-cursor="hover">Store</Link></li>
              <li><Link to="/contact" className="cursor-target hover:text-[var(--ink)] transition" data-cursor="hover">Contact</Link></li>
            </ul>
          </div>
          <div className="md:col-span-2">
            <p className="font-mono text-[10px] uppercase tracking-widest text-[var(--muted)]">Internal</p>
            <ul className="mt-4 space-y-2 text-[15px] text-[var(--ink-2)]">
              <li><Link to="/dashboard" className="cursor-target hover:text-[var(--ink)] transition" data-cursor="hover">Founder Dashboard</Link></li>
              <li><Link to="/contact" className="cursor-target hover:text-[var(--ink)] transition" data-cursor="hover">Book a call</Link></li>
            </ul>
          </div>
          <div className="md:col-span-2">
